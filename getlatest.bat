...
set LocalServer=%3
set RemoteServer=%4
set ScriptFileName=~/dev-newton/scripts/sourceinsight/GetLatest-GetToGalaxyAndCopy.sh
...
title getlatest version %FileName%

IF "%LocalServer%" == "" set LocalServer=172.29.14.111
IF "%RemoteServer%" == "" then SET RemoteServer=farmer
