...
set RemoteServer=%4
set Comment=%5
set ScriptFileName=~/dev-newton/scripts/sourceinsight/Checkin-CopyToGalaxyAndCheckin.sh
...
C:\Cygwin\bin\ssh.exe okatz@%LocalServer% "%ScriptFileName% %FileName% %BaseFolder% %RemoteServer% \"\" \"%Comment%\""
